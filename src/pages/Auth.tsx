...
const Auth = () => {
  ...
  const handleLoginWithEmail = async (values: LoginFormValues) => {
    setLoading(true);
    setAuthError(null);
    try {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 dark:bg-gray-900">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold">ValueTrack</h1>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="space-y-4">
              ...
              <CardContent>
                <Form {...loginForm}>
                  <form
                    onSubmit={loginForm.handleSubmit(handleLoginWithEmail)}
                    className="space-y-4"
                  >
                    <FormField
            ...
            <TabsContent value="signup" className="space-y-4">
              ...
              <CardContent>
                <Form {...signupForm}>
                  <form
                    onSubmit={signupForm.handleSubmit(handleSignupWithEmail)}
                    className="space-y-4"
                  >
                    <FormField
